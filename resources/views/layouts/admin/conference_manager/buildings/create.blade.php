...
@section('title','Create Buildings')
@section('css')
...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Create Buildings</h3>
            ...
            <form  method="post" action="{{ route('admin_buildings_store', ["conference_id" => $conference->id]) }}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->first('abbrev') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" type="text" id="abbrev" name="abbrev" placeholder="Enter Abbrev" value="{{ old('abbrev') }}" required>
