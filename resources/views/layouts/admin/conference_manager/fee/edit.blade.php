...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            <!-- form start -->
            <form  method="post" action="{{ route('admin_fee_update', ["conference_id" => $conference->id, 'id' => $fee->id]) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group {{ $errors->first('time') ? 'has-error' : ''}}">
                    ...
                    <div class="input-group">
                        ...
                        <input id="time" type='text' class="form-control" name="time" required value="{{ $fee->time }}" />
                    </div>
                    @if ($errors->has('time'))
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body no-padding">
                            <div class="form-group {{ $errors->first('category') ? 'has-error' : ''}}">
                                ...
                                <input id="category" class="form-control" placeholder="Enter Category" name="category" value="{{ $fee->category }}" required>
                            ...
                            <div class="form-group {{ $errors->first('price_before_time') ? 'has-error' : ''}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" id="price_before_time" name="price_before_time" placeholder="Enter Price Before Time" value="{{ $fee->price_before_time }}" required>
                            ...
                            <div class="form-group {{ $errors->first('price_after_time') ? 'has-error' : ''}}">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="text" id="price_after_time" name="price_after_time" placeholder="Enter Price After Time" value="{{ $fee->price_after_time }}" required>
                                    <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                                </div>
                            ...
                            <div class="form-group {{ $errors->first('description') ? 'has-error' : ''}}">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="6" placeholder="Enter discription for Fee">{{ $fee->description }}</textarea>
...
<script type="text/javascript" src="{{ asset('js/admin/fee/edit.js') }}"></script>
@endsection
