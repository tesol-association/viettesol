...
@section('content')
    ...
    <form  method="post" action="{{ route('admin_timeline_store', ["conference_id" => $conference->id]) }}">
        @csrf
    <div class="box box-primary">
        <div class="box-header">
        ...
        <div class="box-body">
            ...
            <div class="form-group {{ $errors->first('author_registration_opened') ? 'has-error' : ''}}">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" required class="form-control pull-right" name="author_registration_opened" id="author_registration_opened" value="{{ old('author_registration_opened') }}">
                </div>
            ...
            <div class="form-group {{ $errors->first('author_registration_closed') ? 'has-error' : ''}}">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" required class="form-control pull-right" name="author_registration_closed" id="author_registration_closed" value="{{ old('author_registration_closed') }}">
                </div>
            ...
            <div class="form-group {{ $errors->first('submission_accepted') ? 'has-error' : ''}}">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" required class="form-control pull-right" name="submission_accepted" id="submission_accepted" value="{{ old('submission_accepted') }}">
                </div>
            ...
            <div class="form-group {{ $errors->first('submission_closed') ? 'has-error' : ''}}">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" required class="form-control pull-right" name="submission_closed" id="submission_closed" value="{{ old('submission_closed') }}">
                </div>
        ...
        <div class="box-body">
            <div class="form-group {{ $errors->first('reviewer_registration_opened') ? 'has-error' : ''}}">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" required class="form-control pull-right" name="reviewer_registration_opened" id="reviewer_registration_opened" value="{{ old('reviewer_registration_opened') }}">
                </div>
            ...
            <div class="form-group {{ $errors->first('reviewer_registration_closed') ? 'has-error' : ''}}">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" required class="form-control pull-right" name="reviewer_registration_closed" id="reviewer_registration_closed" value="{{ old('reviewer_registration_closed') }}">
                </div>
            ...
            <div class="form-group {{ $errors->first('review_deadline') ? 'has-error' : ''}}">
                ...
                <div class="input-group date">
                    ...
                    <input type="text" required class="form-control pull-right" name="review_deadline" id="review_deadline" value="{{ old('review_deadline') }}">
                </div>
