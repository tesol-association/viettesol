    ...
    <form  method="POST" action="{{ route('admin_user_update',['id'=> $users->id ]) }}">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input id="fax" type="text" class="form-control{{ $errors->has('fax') ? ' is-invalid' : '' }}" name="fax"  placeholder="Enter Fax" value="{{ $users->fax }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('country') ? ' is-invalid' : '' }}" id="country" name="country" data-value="{{ $users->country }}">
