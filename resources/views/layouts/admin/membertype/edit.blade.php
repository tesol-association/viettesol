...
<div class="box box-primary">
    ...
    <form method="post" action="{{ route('admin_membertype_update', ["id" => $memberType->id]) }}">
        @csrf
        <div class="box-body">

            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name"> Name*: </label>
                <input id="name" type="text" class="form-control" name="name" required value="{{ $memberType->name }}">
                @if ($errors->has('name'))
