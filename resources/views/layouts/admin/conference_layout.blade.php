        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('admin_schedule_list', ["conference_id" => $conference->id]) }}">Schedule</a></li>
                        <li><a href="{{ route('admin_time_block_list', ["conference_id" => $conference->id]) }}">Time Block</a></li>
