...
@section('content')
    <div class="contact">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact_info_container" style="max-width: 100%;">
                        <div>
                            <a href="#">
                                <div class="logo_container d-flex flex-row align-items-start justify-content-start">
                                    ...
                                    <div class="logo_content">
                                        ...
                                        <div class="logo_sub">{{ \Carbon\Carbon::parse($conference->start_time)->format('d/m/Y') }}-{{ \Carbon\Carbon::parse($conference->end_time)->format('d/m/Y') }}</div>
                                    </div>
                                </div>
                            </a>    
                        </div>
